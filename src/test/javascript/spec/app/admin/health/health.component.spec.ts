...
import { KeycHealthCheckComponent } from 'app/admin/health/health.component';
import { KeycHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
    describe('KeycHealthCheckComponent', () => {
        let comp: KeycHealthCheckComponent;
        let fixture: ComponentFixture<KeycHealthCheckComponent>;
        let service: KeycHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [HellokeycTestModule],
                declarations: [KeycHealthCheckComponent]
            })
                .overrideTemplate(KeycHealthCheckComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(KeycHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(KeycHealthService);
        });

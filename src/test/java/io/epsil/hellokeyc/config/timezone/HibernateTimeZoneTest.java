package io.epsil.hellokeyc.config.timezone;

import io.epsil.hellokeyc.HellokeycApp;
import io.epsil.hellokeyc.repository.timezone.DateTimeWrapper;
import io.epsil.hellokeyc.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneTest {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM keyc_date_time_wrapper where id=%d", fieldName, id);
    }

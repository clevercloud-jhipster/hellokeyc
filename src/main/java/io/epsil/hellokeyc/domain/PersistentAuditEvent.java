package io.epsil.hellokeyc.domain;
 ...
 */
@Entity
@Table(name = "keyc_persistent_audit_event")
public class PersistentAuditEvent implements Serializable {
    ...
    @Column(name = "value")
    @CollectionTable(name = "keyc_persistent_audit_evt_data", joinColumns=@JoinColumn(name="event_id"))
